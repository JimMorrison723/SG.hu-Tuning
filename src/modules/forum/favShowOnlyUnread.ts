...
import { showNavigationButtons } from '../topik/showNavigationButtons'
...
favShowOnlyUnread.activate = () => {
  ...
  const ext_faves = $('#sidebar-user-favorites')
  ...
  ext_filtered_faves = $('#ext_show_filtered_faves')
  ext_filtered_faves.append('<span id="ext_show_filtered_faves_arrow"></span>')
  ext_filtered_faves_arrow = $('#ext_show_filtered_faves_arrow')
  ext_filtered_error = $('#ext_filtered_faves_error')
